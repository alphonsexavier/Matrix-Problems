...
Problem Statement
Consider a matrix A of size Rnd×nd, where each non-overlapping d×d block of the matrix, Dij, is a diagonal matrix. So the matrix consists of n2 such blocks. An example of such a matrix is shown below:
...
Source - http://hal.cse.msu.edu/misc/join/
